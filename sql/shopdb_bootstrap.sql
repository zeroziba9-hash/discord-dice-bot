-- Shop DB bootstrap
-- Run this in MySQL Workbench as an admin account (e.g., root)

CREATE DATABASE IF NOT EXISTS clawmart
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_0900_ai_ci;

CREATE USER IF NOT EXISTS 'claw_admin'@'localhost' IDENTIFIED BY '123';
GRANT ALL PRIVILEGES ON clawmart.* TO 'claw_admin'@'localhost';
FLUSH PRIVILEGES;
...
-- Quick sanity check
SELECT 'bootstrap_done' AS status, DATABASE() AS db_name;
